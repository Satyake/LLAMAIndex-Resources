[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/#_top)
...
[Section titled “Calling tools directly”](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/#calling-tools-directly)
```
...
## Direct prompting
[Section titled “Direct prompting”](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/#direct-prompting)
...
## Other Guides
[Section titled “Other Guides”](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/#other-guides)
For a deeper look at structured data extraction with LlamaIndex, check out the following guides:


## Bonus Track
[Section titled “Bonus Track”](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level/#bonus-track)
If you’re curious of learning how to boost your LLM’s performance using structured inputs, check out [this guide](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_input)!
