...
---|---  
###  acustom_query `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/NL_SQL_table/#llama_index.core.query_engine.CustomQueryEngine.acustom_query "Permanent link")
```
...
---|---  
###  agenerate_query `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/NL_SQL_table/#llama_index.core.query_engine.KnowledgeGraphQueryEngine.agenerate_query "Permanent link")
```
