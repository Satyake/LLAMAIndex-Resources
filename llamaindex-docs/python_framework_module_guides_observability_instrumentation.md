[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#_top)
# Instrumentation
Copy as Markdown
MCP Server
...
[Section titled “Using the Instrumentation Module for Observability”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#using-the-instrumentation-module-for-observability)
...
Check out our [observability guide](https://developers.llamaindex.ai/python/framework/module_guides/observability) for more details on supported partners.
## Usage
[Section titled “Usage”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#usage)
...
elifisinstance(event, LLMChatInProgressEvent):
...
See the [full guide](https://developers.llamaindex.ai/python/examples/instrumentation/instrumentation_observability_rundown) on all events logged in LlamaIndex, or visit the [api reference](https://developers.llamaindex.ai/python/framework-api-reference/instrumentation) for more details.
### Defining a custom `EventHandler`
[Section titled “Defining a custom EventHandler”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#defining-a-custom-eventhandler)
...
defhandle(self, event: BaseEvent, **kwargs) -> Any:
...
[Section titled “Defining a custom Event”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#defining-a-custom-event)
...
[Section titled “Defining a custom Span”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#defining-a-custom-span)
...
[Section titled “Entering/Exiting a Span”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#enteringexiting-a-span)
...
[Section titled “Making use of dispatcher hierarchy”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#making-use-of-dispatcher-hierarchy)
...
## Notebook Guides:
[Section titled “Notebook Guides:”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#notebook-guides)
  * [Observing Model Calls](https://developers.llamaindex.ai/python/examples/instrumentation/observe_api_calls)
  * [Observing All Events](https://developers.llamaindex.ai/python/examples/instrumentation/instrumentation_observability_rundown)


## API Reference
[Section titled “API Reference”](https://developers.llamaindex.ai/python/framework/module_guides/observability/instrumentation/#api-reference)
  * [Instrumentation API Reference](https://developers.llamaindex.ai/python/framework-api-reference/instrumentation)
