[Skip to content](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#_top)
# Agent Data (Python)
Copy as Markdown
MCP Server
...
### Install
[Section titled “Install”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#install)
Terminal window```
...
### Client overview
[Section titled “Client overview”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#client-overview)
...
[Section titled “Create, Get, Update, Delete”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#create-get-update-delete)
```
...
### Delete by query
[Section titled “Delete by query”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#delete-by-query)
...
### Search
[Section titled “Search”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#search)
...
### Aggregate
[Section titled “Aggregate”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#aggregate)
...
### Untyped APIs
[Section titled “Untyped APIs”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#untyped-apis)
...
[Section titled “ExtractedData wrapper”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-python/#extracteddata-wrapper)
