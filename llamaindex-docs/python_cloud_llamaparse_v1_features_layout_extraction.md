[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/layout_extraction/#_top)
# Layout Extraction
Copy as Markdown
MCP Server
...
[Section titled “Ignore document elements for layout detection”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/layout_extraction/#ignore-document-elements-for-layout-detection)
...
## Example
[Section titled “Example”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/layout_extraction/#example)
```
...
## Cost
[Section titled “Cost”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/layout_extraction/#cost)
