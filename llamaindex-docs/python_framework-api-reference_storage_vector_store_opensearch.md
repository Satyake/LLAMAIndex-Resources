...
---|---  
###  async_add `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorStore.async_add "Permanent link")
```
...
---|---  
###  adelete `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorStore.adelete "Permanent link")
```
...
---|---  
###  adelete_nodes `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorStore.adelete_nodes "Permanent link")
```
...
---|---  
###  aclear `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorStore.aclear "Permanent link")
```
aclear() -> None
...
---|---  
###  aquery `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorStore.aquery "Permanent link")
```
aquery(query: , **kwargs: ) -> 
...
`method` |  `Optional[dict]` |  Opensearch "method" JSON obj for configuring the KNN index. This includes engine, metric, and other config params. Defaults to: {"name": "hnsw", "space_type": "l2", "engine": "nmslib", "parameters": {"ef_construction": 256, "m": 48}} |  `None`  
...
---|---  
###  aindex_results `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorClient.aindex_results "Permanent link")
```
aindex_results(nodes: [], **kwargs: ) -> []
...
---|---  
###  adelete_by_doc_id `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorClient.adelete_by_doc_id "Permanent link")
```
...
---|---  
###  adelete_nodes `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorClient.adelete_nodes "Permanent link")
```
adelete_nodes(node_ids: Optional[[]] = None, filters: Optional[] = None, **delete_kwargs: ) -> None
...
---|---  
###  aclear `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/storage/vector_store/opensearch/#llama_index.vector_stores.opensearch.OpensearchVectorClient.aclear "Permanent link")
```
aclear() -> None
