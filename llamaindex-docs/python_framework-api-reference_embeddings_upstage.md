# Upstage
##  UpstageEmbedding [#](https://developers.llamaindex.ai/python/framework-api-reference/embeddings/upstage/#llama_index.embeddings.upstage.UpstageEmbedding "Permanent link")
Bases: 
Class for Upstage embeddings.
Source code in `llama_index/embeddings/upstage/base.py`
```
 45
 46
 47
...
---|---  
options: members: - UpstageEmbedding
