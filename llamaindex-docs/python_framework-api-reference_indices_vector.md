...
---|---  
###  ainsert_nodes `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/vector/#llama_index.core.indices.VectorStoreIndex.ainsert_nodes "Permanent link")
```
...
---|---  
###  adelete_nodes `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/vector/#llama_index.core.indices.VectorStoreIndex.adelete_nodes "Permanent link")
```
...
---|---  
###  adelete_ref_doc `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/indices/vector/#llama_index.core.indices.VectorStoreIndex.adelete_ref_doc "Permanent link")
```
