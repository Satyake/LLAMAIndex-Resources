...
---|---  
###  aget_response `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/simple_summarize/#llama_index.core.response_synthesizers.Accumulate.aget_response "Permanent link")
```
...
---|---  
###  aget_response `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers/simple_summarize/#llama_index.core.response_synthesizers.TreeSummarize.aget_response "Permanent link")
```
aget_response(query_str: , text_chunks: Sequence[], **response_kwargs: ) -> RESPONSE_TEXT_TYPE
