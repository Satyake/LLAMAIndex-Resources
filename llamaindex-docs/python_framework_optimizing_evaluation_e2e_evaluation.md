[Skip to content](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/#_top)
...
[Section titled “Setting up an Evaluation Set”](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/#setting-up-an-evaluation-set)
...
We’ve created some tools that automatically generate a dataset for you given a set of documents to query. (See example below).
  * [Question Generation](https://developers.llamaindex.ai/python/examples/evaluation/questiongeneration)


In the future, we will also be able to create datasets automatically against tools.
## The Spectrum of Evaluation Options
[Section titled “The Spectrum of Evaluation Options”](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/#the-spectrum-of-evaluation-options)
...
Below is some example usage of the [evaluation modules](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/evaluation):
  * [Batch Eval Runner](https://developers.llamaindex.ai/python/examples/evaluation/batch_eval)
  * [Semantic Similarity Eval](https://developers.llamaindex.ai/python/examples/evaluation/semantic_similarity_eval)


## Discovery - Sensitivity Testing
[Section titled “Discovery - Sensitivity Testing”](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/#discovery---sensitivity-testing)
...
## Metrics Ensembling
[Section titled “Metrics Ensembling”](https://developers.llamaindex.ai/python/framework/optimizing/evaluation/e2e_evaluation/#metrics-ensembling)
