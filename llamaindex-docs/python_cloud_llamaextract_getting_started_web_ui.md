...
The web UI makes it easy to test and iterate on your schema. Once you’re happy with a schema, you can scalably run extractions via [the SDK](https://developers.llamaindex.ai/python/cloud/llamaextract/getting_started/sdk).
