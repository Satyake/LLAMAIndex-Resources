[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#_top)
# Python Usage
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Python options
[Section titled “Python options”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#python-options)
Some parameters are specific to the Python implementation
## Number of workers
[Section titled “Number of workers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#number-of-workers)
...
## Check interval
[Section titled “Check interval”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#check-interval)
...
## Verbose mode
[Section titled “Verbose mode”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#verbose-mode)
...
[Section titled “Use with SimpleDirectoryReader”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#use-with-simpledirectoryreader)
...
## Direct usage
[Section titled “Direct usage”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#direct-usage)
It is also possible to call the parser directly, in one of 4 modes:
#### Synchronous parsing
[Section titled “Synchronous parsing”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#synchronous-parsing)
```
...
[Section titled “Synchronous batch parsing”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#synchronous-batch-parsing)
```
...
[Section titled “Asynchronous parsing”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#asynchronous-parsing)
```
...
[Section titled “Asynchronous batch parsing”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#asynchronous-batch-parsing)
```
...
[Section titled “Large document partitioning”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/python_usage/#large-document-partitioning)
