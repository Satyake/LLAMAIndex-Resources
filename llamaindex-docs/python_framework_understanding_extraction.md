[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/extraction/#_top)
...
## What is Pydantic?
[Section titled “What is Pydantic?”](https://developers.llamaindex.ai/python/framework/understanding/extraction/#what-is-pydantic)
...
[Section titled “Converting Pydantic objects to JSON schemas”](https://developers.llamaindex.ai/python/framework/understanding/extraction/#converting-pydantic-objects-to-json-schemas)
...
## Using annotations
[Section titled “Using annotations”](https://developers.llamaindex.ai/python/framework/understanding/extraction/#using-annotations)
...
Now that you have a basic understanding of Pydantic and the schemas it generates, you can move on to using Pydantic classes for structured data extraction in LlamaIndex, starting with [Structured LLMs](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_llms).
