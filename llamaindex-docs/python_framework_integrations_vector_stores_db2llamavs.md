...
filters=[ExactMatchFilter="rank",value="c")]
...
ExactMatchFilter="rank",value="c"),




ExactMatchFilter="weight",value=2),
...
ExactMatchFilter="weight",value=3),
...
filters=[ExactMatchFilter="unknown_field",value="c")]
