[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline/transformations/#_top)
# Transformations
Copy as Markdown
MCP Server
...
## Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline/transformations/#usage-pattern)
While transformations are best used with with an [`IngestionPipeline`](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline), they can also be used directly.
```
...
[Section titled “Combining with An Index”](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline/transformations/#combining-with-an-index)
...
[Section titled “Custom Transformations”](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline/transformations/#custom-transformations)
