...
Source code in `llama_index/tools/azure_code_interpreter/base.py`
```
 70
 71
 72
...
```
access_token_provider: Callable[[], Optional[]] = _access_token_provider_factory()
...
```
upload_file(data: Optional[] = None, local_file_path: Optional[] = None) -> [RemoteFileMetadata]
...
```
download_file_to_local(remote_file_path: , local_file_path: Optional[] = None) -> Optional[BufferedReader]
