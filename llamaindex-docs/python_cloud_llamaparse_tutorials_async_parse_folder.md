[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#setup)
### Environment Variables
[Section titled “Environment Variables”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#environment-variables)
...
[Section titled “Install Dependencies”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#install-dependencies)
Terminal window```
...
## Quick Start
[Section titled “Quick Start”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#quick-start)
### Download Example PDFs
[Section titled “Download Example PDFs”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#download-example-pdfs)
...
[Section titled “Use Asyncio and Semaphore with LlamaParse”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#use-asyncio-and-semaphore-with-llamaparse)
...
print(f"✓ Completed: {file_path.name} ((result.items.pages)} pages)")
...
"pages": len(result.items.pages) if result.items.pages else0,
...
## Example Output
[Section titled “Example Output”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#example-output)
```
...
## How It Works
[Section titled “How It Works”](https://developers.llamaindex.ai/python/cloud/llamaparse/tutorials/async_parse_folder/#how-it-works)
