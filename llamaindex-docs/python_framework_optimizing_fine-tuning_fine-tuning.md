[Skip to content](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#_top)
# Fine-tuning
## Overview
[Section titled “Overview”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#overview)
...
[Section titled “Embedding Finetuning Benefits”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#embedding-finetuning-benefits)
...
[Section titled “LLM Finetuning Benefits”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#llm-finetuning-benefits)
...
[Section titled “Integrations with LlamaIndex”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#integrations-with-llamaindex)
...
[Section titled “Finetuning Embeddings”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#finetuning-embeddings)
...
Finetuning gives you a 5-10% increase in retrieval evaluation metrics. You can then plug this fine-tuned model into your RAG application with LlamaIndex.
  * [Fine-tuning an Adapter](https://developers.llamaindex.ai/python/examples/finetuning/embeddings/finetune_embedding_adapter)
  * [Embedding Fine-tuning Guide](https://developers.llamaindex.ai/python/examples/finetuning/embeddings/finetune_embedding)
  * [Router Fine-tuning](https://developers.llamaindex.ai/python/examples/finetuning/router/router_finetune)
...
## Fine-tuning LLMs
[Section titled “Fine-tuning LLMs”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-llms)
### Fine-tuning GPT-3.5 to distill GPT-4
[Section titled “Fine-tuning GPT-3.5 to distill GPT-4”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-gpt-35-to-distill-gpt-4)
...
We then launch a finetuning job, and get back a distilled model. We can evaluate this model with [Ragas](https://github.com/explodinggradients/ragas) to benchmark against a naive GPT-3.5 workflow.
  ...
  * [GPT-3.5 Fine-tuning Notebook (Notebook link)](https://developers.llamaindex.ai/python/examples/finetuning/openai_fine_tuning)
  * [[WIP] Function Calling Fine-tuning](https://developers.llamaindex.ai/python/examples/finetuning/openai_fine_tuning_functions)
...
[Section titled “Fine-tuning for Better Structured Outputs”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-for-better-structured-outputs)
Another use case for fine-tuning is to make the model better at outputting structured data. We can do this for both OpenAI and Llama2.
  * [OpenAI Function Calling Fine-tuning](https://developers.llamaindex.ai/python/examples/finetuning/openai_fine_tuning_functions)


### Fine-tuning Llama 2 for Better Text-to-SQL
[Section titled “Fine-tuning Llama 2 for Better Text-to-SQL”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-llama-2-for-better-text-to-sql)
...
[Section titled “Fine-tuning An Evaluator”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-an-evaluator)
...
Thus, by fine-tuning a GPT-3.5 judge, we may be able to reach GPT-4 levels (and by proxy, agreement with humans) at a lower cost.
  * [Finetune Correctness Judge](https://developers.llamaindex.ai/python/examples/finetuning/llm_judge/correctness/finetune_llm_judge_single_grading_correctness)


## Fine-tuning Cross-Encoders for Re-Ranking
[Section titled “Fine-tuning Cross-Encoders for Re-Ranking”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#fine-tuning-cross-encoders-for-re-ranking)
...
In this example, we use the `sentence-transformers` package to help finetune a crossencoder model, using a dataset that is generated based on the `QASPER` dataset.
  * [Cross-Encoder Finetuning](https://developers.llamaindex.ai/python/examples/finetuning/cross_encoder_finetuning/cross_encoder_finetuning)
...
[Section titled “Cohere Custom Reranker”](https://developers.llamaindex.ai/python/framework/optimizing/fine-tuning/fine-tuning/#cohere-custom-reranker)
...
In this example, we use the `cohere` custom reranker training module to create a reranker on your domain or specific dataset to improve retrieval performance.
  * [Cohere Custom Reranker](https://developers.llamaindex.ai/python/examples/finetuning/rerankers/cohere_custom_reranker)
