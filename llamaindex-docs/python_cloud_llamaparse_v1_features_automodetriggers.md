[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#_top)
...
[Section titled “Content-Based Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#content-based-triggers)
...
## File-Based Triggers
[Section titled “File-Based Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#file-based-triggers)
Trigger | Description | Example  
---|---|---  
...
[Section titled “Text Metrics Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#text-metrics-triggers)
Trigger | Description | Example  
---|---|---  
...
[Section titled “Element Count Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#element-count-triggers)
Trigger | Description | Example  
---|---|---  
...
[Section titled “Numeric Content Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#numeric-content-triggers)
Trigger | Description | Example  
---|---|---  
...
[Section titled “Layout-Based Triggers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#layout-based-triggers)
Trigger | Description | Example  
---|---|---  
...
## Usage Example
[Section titled “Usage Example”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#usage-example)
...
## Notes
[Section titled “Notes”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/automodetriggers/#notes)
