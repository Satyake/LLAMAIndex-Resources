[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#_top)
# Document Stores
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
Document stores contain ingested document chunks, which we call `Node` objects.
See the [API Reference](https://developers.llamaindex.ai/python/framework-api-reference/storage/docstore) for more details.
### Simple Document Store
[Section titled “Simple Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#simple-document-store)
...
A more complete example can be found [here](https://developers.llamaindex.ai/python/examples/docstore/docstoredemo)
### MongoDB Document Store
[Section titled “MongoDB Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#mongodb-document-store)
...
docstore = MongoDocumentStore.from_uri="<mongodb+srv://...>")
...
[Section titled “Redis Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#redis-document-store)
...
[Section titled “Firestore Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#firestore-document-store)
...
A more complete example can be found [here](https://developers.llamaindex.ai/python/examples/docstore/firestoredemo)
### Couchbase Document Store
[Section titled “Couchbase Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#couchbase-document-store)
...
[Section titled “Tablestore Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#tablestore-document-store)
...
[Section titled “Google AlloyDB Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#google-alloydb-document-store)
...
[Section titled “Google Cloud SQL for PostgreSQL Document Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores/#google-cloud-sql-for-postgresql-document-store)
