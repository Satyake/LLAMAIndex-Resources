# Sagemaker endpoint
##  SageMakerEmbedding [#](https://developers.llamaindex.ai/python/framework-api-reference/embeddings/sagemaker_endpoint/#llama_index.embeddings.sagemaker_endpoint.SageMakerEmbedding "Permanent link")
Bases: 
Source code in `llama_index/embeddings/sagemaker_endpoint/base.py`
```
 17
 18
 19
...
---|---  
options: members: - SageMakerEmbedding
