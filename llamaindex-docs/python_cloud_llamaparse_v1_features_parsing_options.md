[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#_top)
# Parsing options
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Set language
[Section titled “Set language”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#set-language)
...
## Disable OCR
[Section titled “Disable OCR”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#disable-ocr)
...
## Skip diagonal text
[Section titled “Skip diagonal text”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#skip-diagonal-text)
...
[Section titled “Do not unroll columns”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#do-not-unroll-columns)
...
## Target pages
[Section titled “Target pages”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#target-pages)
...
## Page separator
[Section titled “Page separator”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#page-separator)
...
[Section titled “Page prefix and suffix”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#page-prefix-and-suffix)
...
## Bounding box
[Section titled “Bounding box”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#bounding-box)
...
## Take screenshot
[Section titled “Take screenshot”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#take-screenshot)
...
[Section titled “Disable image extraction”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#disable-image-extraction)
...
[Section titled “Extract multiple table per sheet in spreadsheet”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#extract-multiple-table-per-sheet-in-spreadsheet)
...
[Section titled “Force re-computation of cells containing formulas in spreadsheet”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#force-re-computation-of-cells-containing-formulas-in-spreadsheet)
...
[Section titled “Output table as HTML in markdown”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#output-table-as-html-in-markdown)
...
[Section titled “Preserve alignment across pages”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#preserve-alignment-across-pages)
...
[Section titled “Preserve very small text”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#preserve-very-small-text)
...
## Hide headers
[Section titled “Hide headers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#hide-headers)
...
## Hide footers
[Section titled “Hide footers”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#hide-footers)
...
[Section titled “Page header/footer prefix/suffix”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#page-headerfooter-prefixsuffix)
...
[Section titled “Merge tables across pages in markdown”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#merge-tables-across-pages-in-markdown)
...
[Section titled “Extract out of bounds content in presentation slides”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parsing_options/#extract-out-of-bounds-content-in-presentation-slides)
