[Skip to content](https://developers.llamaindex.ai/python/framework/integrations/llm/featherlessai/#_top)
# Featherless AI LLM 
Copy as Markdown
MCP Server
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/framework/integrations/llm/featherlessai/#setup)
...
[Section titled “Call chat with a list of messages”](https://developers.llamaindex.ai/python/framework/integrations/llm/featherlessai/#call-chat-with-a-list-of-messages)
```
...
### Streaming
[Section titled “Streaming”](https://developers.llamaindex.ai/python/framework/integrations/llm/featherlessai/#streaming)
