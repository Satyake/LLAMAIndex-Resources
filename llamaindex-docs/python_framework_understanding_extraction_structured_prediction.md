[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_prediction/#_top)
...
## Under the hood
[Section titled “Under the hood”](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_prediction/#under-the-hood)
...
[Section titled “FunctionCallingProgram”](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_prediction/#functioncallingprogram)
...
[Section titled “LLMTextCompletionProgram”](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_prediction/#llmtextcompletionprogram)
...
[Section titled “Calling prediction classes directly”](https://developers.llamaindex.ai/python/framework/understanding/extraction/structured_prediction/#calling-prediction-classes-directly)
...
classMyOutputParser(PydanticOutputParser):




defget_pydantic_object(self, text: str):
...
returnself.output_parser.model_validate_json(text)
...
In the final section we will take a look at even [lower-level calls to the extract structured data](https://developers.llamaindex.ai/python/framework/understanding/extraction/lower_level), including extracting multiple structures in the same call.
