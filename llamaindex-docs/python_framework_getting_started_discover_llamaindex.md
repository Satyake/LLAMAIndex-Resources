[Skip to content](https://developers.llamaindex.ai/python/framework/getting_started/discover_llamaindex/#_top)
# Discover LlamaIndex Video Series
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
If you like learning from videos, now’s a good time to check out our “Discover LlamaIndex” series. If not, we recommend heading on to our [Understanding LlamaIndex](https://developers.llamaindex.ai/python/framework/understanding) tutorial.
## Bottoms-Up Development (Llama Docs Bot)
[Section titled “Bottoms-Up Development (Llama Docs Bot)”](https://developers.llamaindex.ai/python/framework/getting_started/discover_llamaindex/#bottoms-up-development-llama-docs-bot)
...
[Section titled “SubQuestionQueryEngine + 10K Analysis”](https://developers.llamaindex.ai/python/framework/getting_started/discover_llamaindex/#subquestionqueryengine--10k-analysis)
...
[Section titled “Discord Document Management”](https://developers.llamaindex.ai/python/framework/getting_started/discover_llamaindex/#discord-document-management)
...
[Reference Docs](https://developers.llamaindex.ai/python/framework/module_guides/indexing/document_management)
## Joint Text to SQL and Semantic Search
[Section titled “Joint Text to SQL and Semantic Search”](https://developers.llamaindex.ai/python/framework/getting_started/discover_llamaindex/#joint-text-to-sql-and-semantic-search)
