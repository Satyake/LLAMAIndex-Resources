[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#_top)
...
## Uploading Text
[Section titled “Uploading Text”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#uploading-text)
...
## LLM Settings
[Section titled “LLM Settings”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#llm-settings)
...
[Section titled “Extracting and Storing Terms”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#extracting-and-storing-terms)
...
defget_llm(llm_name, model_temperature, api_key, max_tokens=256):
...
forin terms_definitions.split("\n")




ifand"Term:"inand"Definition:"in x
...
[Section titled “Saving Extracted Terms”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#saving-extracted-terms)
...
if"all_terms"notin st.session_state:
...
definsert_terms(terms_to_definition):
...
definitialize_index(llm_name, model_temperature, api_key):
...
[Section titled “Querying for Extracted Terms/Definitions”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#querying-for-extracted-termsdefinitions)
...
## Dry Run Test
[Section titled “Dry Run Test”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#dry-run-test)
...
[Section titled “Improvement #1 - Create a Starting Index”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-1---create-a-starting-index)
...
[Section titled “Improvement #2 - (Refining) Better Prompts”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-2---refining-better-prompts)
...
from constants importREFINE_TEMPLATE, TEXT_QA_TEMPLATE
...
[Section titled “Improvement #3 - Image Support”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#improvement-3---image-support)
...
## Conclusion/TLDR
[Section titled “Conclusion/TLDR”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/q_and_a/terms_definitions_tutorial/#conclusiontldr)
