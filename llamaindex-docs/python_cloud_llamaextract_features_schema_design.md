...
[Section titled “Defining Schemas with SDKs”](https://developers.llamaindex.ai/python/cloud/llamaextract/features/schema_design/#defining-schemas-with-sdks)
...
[Section titled “Using Zod (Recommended)”](https://developers.llamaindex.ai/python/cloud/llamaextract/features/schema_design/#using-zod-recommended)
```
...
const ExperienceSchemaz.object({
...
const schemaResumeSchema.toJSON();


```

### Using JSON Schema
[Section titled “Using JSON Schema”](https://developers.llamaindex.ai/python/cloud/llamaextract/features/schema_design/#using-json-schema-1)
```
