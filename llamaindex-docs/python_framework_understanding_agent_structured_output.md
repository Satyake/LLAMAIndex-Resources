[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/agent/structured_output/#_top)
...
### Use `output_cls`
[Section titled “Use output_cls”](https://developers.llamaindex.ai/python/framework/understanding/agent/structured_output/#use-output_cls)
```
...
[Section titled “Use structured_output_fn”](https://developers.llamaindex.ai/python/framework/understanding/agent/structured_output/#use-structured_output_fn)
...
asyncdefstructured_output_parsing(
...
defget_flavor(ice_cream_shop: str):
...
[Section titled “Streaming the Structured Output”](https://developers.llamaindex.ai/python/framework/understanding/agent/structured_output/#streaming-the-structured-output)
...
elifisinstance(event, AgentStreamStructuredOutput):
...
elifisinstance(event, AgentOutput):
