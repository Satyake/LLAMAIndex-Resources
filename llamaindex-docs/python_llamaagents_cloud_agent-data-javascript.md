[Skip to content](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#_top)
...
See the [Agent Data Overview](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-overview/) for concepts, constraints, and environment details.
Install:
Terminal window```


npmi-Sllama-cloud-services
...
### Create client
[Section titled “Create client”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#create-client)
...
const clientcreateAgentDataClientPerson({
...
env: process.env as Recordstring, string>,
...
windowUrl: typeofwindow !== "undefined"window.location.hrefundefined,
...
const directnewAgentClientPerson({
...
### CRUD operations
[Section titled “CRUD operations”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#crud-operations)
```
...
### Delete by query
[Section titled “Delete by query”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#delete-by-query)
...
### Search
[Section titled “Search”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#search)
```
...
const results:TypedAgentDataItemsPerson> = await client.search(options);




for (const rof results.items) {
...
See the [Agent Data Overview](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-overview/#filter-dsl) for more details on filters.
...
### Aggregate
[Section titled “Aggregate”](https://developers.llamaindex.ai/python/llamaagents/cloud/agent-data-javascript/#aggregate)
```
...
const groups:TypedAggregateGroupItemsPerson> = await client.aggregate(aggOptions);




for (const gof groups.items) {
