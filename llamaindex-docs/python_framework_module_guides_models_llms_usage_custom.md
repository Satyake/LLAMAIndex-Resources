[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/models/llms/usage_custom/#_top)
...
[Section titled “Example: Changing the underlying LLM”](https://developers.llamaindex.ai/python/framework/module_guides/models/llms/usage_custom/#example-changing-the-underlying-llm)
...
[Section titled “Example: Using a Custom LLM Model - Advanced”](https://developers.llamaindex.ai/python/framework/module_guides/models/llms/usage_custom/#example-using-a-custom-llm-model---advanced)
...
Note that for a completely private experience, also setup a [local embeddings model](https://developers.llamaindex.ai/python/framework/module_guides/models/embeddings).
...
returnCompletionResponse(text=self.dummy_response)
...
for token inself.dummy_response:
...
yieldCompletionResponse(text=response,delta=token)
...
A list of all default internal prompts is available [here](https://github.com/run-llama/llama_index/blob/main/llama-index-core/llama_index/core/prompts/default_prompts.py), and chat-specific prompts are listed [here](https://github.com/run-llama/llama_index/blob/main/llama_index/prompts/chat_prompts.py). You can also implement [your own custom prompts](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts).
