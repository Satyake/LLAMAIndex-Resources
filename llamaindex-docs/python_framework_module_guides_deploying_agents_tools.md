...
agent =FunctionAgent=llm,tools=tool_spec.to_tool_list())
...
pipinstallllama-index-readers-wikipedia
...
pipinstallllama-index-tools-wikipedia
...
agent =FunctionAgent=llm,tools=[tool])
