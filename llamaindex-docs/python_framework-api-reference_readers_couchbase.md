...
```
lazy_load_data(query: , text_fields: Optional[[]] = None, metadata_fields: Optional[[]] = []) -> Iterable[]
...
```
load_data(query: , text_fields: Optional[[]] = None, metadata_fields: Optional[[]] = None) -> []
