[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/storing/customization/#_top)
# Customizing Storage
Copy as Markdown
MCP Server
...
### Low-Level API
[Section titled “Low-Level API”](https://developers.llamaindex.ai/python/framework/module_guides/storing/customization/#low-level-api)
...
You can customize the underlying storage with a one-line change to instantiate different document stores, index stores, and vector stores. See [Document Stores](https://developers.llamaindex.ai/python/framework/module_guides/storing/docstores), [Vector Stores](https://developers.llamaindex.ai/python/framework/module_guides/storing/vector_stores), [Index Stores](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores) guides for more details.
### Vector Store Integrations and Storage
[Section titled “Vector Store Integrations and Storage”](https://developers.llamaindex.ai/python/framework/module_guides/storing/customization/#vector-store-integrations-and-storage)
