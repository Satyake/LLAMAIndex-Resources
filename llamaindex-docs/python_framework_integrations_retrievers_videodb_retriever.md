[Skip to content](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#_top)
# connect to VideoDB 
Copy as Markdown
MCP Server
...
[Section titled “upload videos to default collection in VideoDB”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#upload-videos-to-default-collection-in-videodb)
...
[Section titled “video = coll.get_video(“m-b6230808-307d-468a-af84-863b2c321f05”)”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#video--collget_videom-b6230808-307d-468a-af84-863b2c321f05)
```
...
[Section titled “🗣️ Retrieving Relevant Nodes from Spoken Index”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-retrieving-relevant-nodes-from-spoken-index)
...
[Section titled “🗣️️️ Viewing the result : 💬 Text”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F%EF%B8%8F%EF%B8%8F-viewing-the-result---text)
...
[Section titled “🗣️ Viewing the result : 🎥 Video Clip”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-viewing-the-result---video-clip)
...
[Section titled “📸️ Step3 : Index & Search from Visual Content”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-step3--index--search-from-visual-content)
#### 📸 Indexing Visual Content
[Section titled “📸 Indexing Visual Content”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-indexing-visual-content)
...
[Section titled “📸️ Retrieving Relevant Nodes from Scene Index”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-retrieving-relevant-nodes-from-scene-index)
...
#### 📸️️️ Viewing the result : 💬 Text
[Section titled “📸️️️ Viewing the result : 💬 Text”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F%EF%B8%8F%EF%B8%8F-viewing-the-result---text-1)
```
...
[Section titled “🛠️ Step4: Simple Multimodal RAG - Combining Results of Both modalities”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-step4-simple-multimodal-rag---combining-results-of-both-modalities)
...
[Section titled “🧩 Query Transformation”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-query-transformation)
```
...
[Section titled “🔎 Finding Relevant nodes for each modality”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-finding-relevant-nodes-for-each-modality)
```
...
[Section titled “️💬️ Viewing the result : Text”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F%EF%B8%8F-viewing-the-result--text)
```
...
[Section titled “🎥 Viewing the result : Video Clip”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-viewing-the-result--video-clip)
...
[Section titled “🛠 Using VideoDBRetriever to Build RAG for Collection of Videos”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-using-videodbretriever-to-build-rag-for-collection-of-videos)
### Adding More videos to our collection
[Section titled “Adding More videos to our collection”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#adding-more-videos-to-our-collection)
```
...
#### 🗣️ Indexing Spoken Content
[Section titled “🗣️ Indexing Spoken Content”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-indexing-spoken-content)
```
...
#### 📸 Indexing Scenes
[Section titled “📸 Indexing Scenes”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-indexing-scenes)
```
...
#### 🧩 Query Transformation
[Section titled “🧩 Query Transformation”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-query-transformation-1)
```
...
[Section titled “🔎 Finding relevant nodes”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-finding-relevant-nodes)
```
...
#### ️💬️ Viewing the result : Text
[Section titled “️💬️ Viewing the result : Text”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F%EF%B8%8F-viewing-the-result--text-1)
```
...
#### 🎥 Viewing the result : Video Clip
[Section titled “🎥 Viewing the result : Video Clip”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-viewing-the-result--video-clip-1)
...
[Section titled “Configuring VideoDBRetriever”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#configuring-videodbretriever)
### ⚙️ Retriever for only one Video
[Section titled “⚙️ Retriever for only one Video”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-retriever-for-only-one-video)
...
[Section titled “⚙️ Retriever for a set of Video/ Collection”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-retriever-for-a-set-of-video-collection)
...
[Section titled “⚙️ Retriever for different type of Indexes”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-retriever-for-different-type-of-indexes)
```
...
[Section titled “⚙️ Configuring Search Type of Retriever”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-configuring-search-type-of-retriever)
...
[Section titled “⚙️ Configure threshold parameters”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-configure-threshold-parameters)
...
[Section titled “✨ Configuring Indexing and Chunking”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-configuring-indexing-and-chunking)
...
## 🏃‍♂️ Next Steps
[Section titled “🏃‍♂️ Next Steps”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#%EF%B8%8F-next-steps)
...
## 👨‍👩‍👧‍👦 Support & Community
[Section titled “👨‍👩‍👧‍👦 Support & Community”](https://developers.llamaindex.ai/python/framework/integrations/retrievers/videodb_retriever/#-support--community)
