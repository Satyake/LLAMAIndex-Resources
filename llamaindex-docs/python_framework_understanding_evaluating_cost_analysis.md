[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#_top)
# Cost Analysis
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Concept
[Section titled “Concept”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#concept)
...
[Section titled “Overview of Cost Structure”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#overview-of-cost-structure)
#### Indices with no LLM calls
[Section titled “Indices with no LLM calls”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#indices-with-no-llm-calls)
...
[Section titled “Indices with LLM calls”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#indices-with-llm-calls)
...
## Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#usage-pattern)
...
Tokens are counted using the `TokenCountingHandler` callback. See the [example notebook](https://developers.llamaindex.ai/python/examples/observability/tokencountinghandler) for details on the setup.
### Using MockLLM
[Section titled “Using MockLLM”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#using-mockllm)
...
### Using MockEmbedding
[Section titled “Using MockEmbedding”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#using-mockembedding)
...
## Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/#usage-pattern-1)
Read about the [full usage pattern](https://developers.llamaindex.ai/python/framework/understanding/evaluating/cost_analysis/usage_pattern) for more details!
