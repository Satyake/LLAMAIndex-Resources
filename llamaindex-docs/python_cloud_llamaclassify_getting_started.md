...
To use Multimodal mode, set the `mode` parameter to `"MULTIMODAL"` when creating a classify job. See the [SDK guide](https://developers.llamaindex.ai/python/cloud/llamaclassify/getting_started/sdk) for usage examples.
## Typical flow
...
[Section titled “Next steps”](https://developers.llamaindex.ai/python/cloud/llamaclassify/getting_started/#next-steps)
  ...
  * Jump straight to the SDK guide to run your first job using [the SDK](https://developers.llamaindex.ai/python/cloud/llamaclassify/getting_started/sdk)
