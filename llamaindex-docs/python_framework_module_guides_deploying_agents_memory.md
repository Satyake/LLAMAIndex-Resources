[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#_top)
# Memory
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Concept
[Section titled “Concept”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#concept)
...
## Usage
[Section titled “Usage”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#usage)
...
[Section titled “Configuring Memory for an Agent”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#configuring-memory-for-an-agent)
...
agent =FunctionAgent=llm,tools=tools)
...
[Section titled “Managing the Memory Manually”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#managing-the-memory-manually)
...
[Section titled “Retrieving the Latest Memory from an Agent”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#retrieving-the-latest-memory-from-an-agent)
...
## Customizing Memory
[Section titled “Customizing Memory”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#customizing-memory)
### Short-Term Memory
[Section titled “Short-Term Memory”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#short-term-memory)
...
### Long-Term Memory
[Section titled “Long-Term Memory”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#long-term-memory)
...
[Section titled “Customizing Memory Blocks”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#customizing-memory-blocks)
...
returnf"Logan was mentioned {self.mention_count} times."
...
ifself.mention_name in message.content:
...
### Remote Memory
[Section titled “Remote Memory”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#remote-memory)
...
[Section titled “Memory vs. Workflow Context”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#memory-vs-workflow-context)
...
Lastly, there are cases ([like human-in-the-loop](https://developers.llamaindex.ai/python/framework/understanding/agent/human_in_the_loop)) where you will need to provide both the `Context` (to resume the workflow) and the `Memory` (to store the chat history).
```
...
[Section titled “(Deprecated) Memory Types”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#deprecated-memory-types)
...
## Examples
[Section titled “Examples”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory/#examples)
You can find a few examples of memory in action below:
  * [Manipulating Memory at Runtime](https://developers.llamaindex.ai/python/examples/memory/custom_memory)
  * [Limiting Multi-Turn Confusion with Custom Memory](https://developers.llamaindex.ai/python/examples/memory/custom_multi_turn_memory)
