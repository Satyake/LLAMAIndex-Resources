[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#_top)
# Prompt Usage Pattern
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Using `RichPromptTemplate` and Jinja Syntax
[Section titled “Using RichPromptTemplate and Jinja Syntax”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#using-richprompttemplate-and-jinja-syntax)
...
[Section titled “Using f-string Prompt Templates”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#using-f-string-prompt-templates)
...
[Section titled “Getting and Setting Custom Prompts”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#getting-and-setting-custom-prompts)
...
See [this guide](https://developers.llamaindex.ai/python/examples/prompts/prompt_mixin) for full details on accessing/customizing prompts.
### Commonly Used Prompts
[Section titled “Commonly Used Prompts”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#commonly-used-prompts)
...
### Accessing Prompts
[Section titled “Accessing Prompts”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#accessing-prompts)
...
### Updating Prompts
[Section titled “Updating Prompts”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#updating-prompts)
...
[Section titled “Modify prompts used in query engine”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#modify-prompts-used-in-query-engine)
...
For more details on which classes use which prompts, please visit [Query class references](https://developers.llamaindex.ai/python/framework-api-reference/response_synthesizers).
Check out the [reference documentation](https://developers.llamaindex.ai/python/framework-api-reference/prompts) for a full set of all prompts and their methods/parameters.
## [Advanced] Advanced Prompt Capabilities
[Section titled “[Advanced] Advanced Prompt Capabilities”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#advanced-advanced-prompt-capabilities)
...
### Function Mappings
[Section titled “Function Mappings”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#function-mappings)
...
### Partial Formatting
[Section titled “Partial Formatting”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#partial-formatting)
...
partial_prompt_tmpl = template.partial_format="abc")





fmt_str = partial_prompt_tmpl.format="def")


```

### Template Variable Mappings
[Section titled “Template Variable Mappings”](https://developers.llamaindex.ai/python/framework/module_guides/models/prompts/usage_pattern/#template-variable-mappings)
