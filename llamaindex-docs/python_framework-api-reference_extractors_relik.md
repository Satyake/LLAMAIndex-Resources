...
Source code in `llama_index/extractors/relik/base.py`
```
 16
 17
 18
...
---|---  
###  acall `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/extractors/relik/#llama_index.extractors.relik.RelikPathExtractor.acall "Permanent link")
```
acall(nodes: [], show_progress:  = False, **kwargs: ) -> []
