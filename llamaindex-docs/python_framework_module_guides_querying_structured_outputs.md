[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/#_top)
# Structured Outputs
Copy as Markdown
MCP Server
...
[Section titled “🔬 Anatomy of a Structured Output Function”](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/#-anatomy-of-a-structured-output-function)
...
## Starter Guides
[Section titled “Starter Guides”](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/#starter-guides)
  * [Structured data extraction tutorial](https://developers.llamaindex.ai/python/framework/understanding/extraction)
  * [Examples of Structured Outputs](https://developers.llamaindex.ai/python/examples/structured_outputs/structured_outputs)


## Other Resources
[Section titled “Other Resources”](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/#other-resources)
  * [Structured Outputs + Query Engines](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/query_engine)
