[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#_top)
...
## Usage
[Section titled “Usage”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#usage)
...
### Construction
[Section titled “Construction”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#construction)
...
If you’ve used transformations or metadata extractors with the [ingestion pipeline](https://developers.llamaindex.ai/python/framework/module_guides/loading/ingestion_pipeline), then this will be very familiar (and these `kg_extractors` are compatible with the ingestion pipeline)!
...
[Section titled “(default) SimpleLLMPathExtractor”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#default-simplellmpathextractor)
...
defparse_fn(response_str: str) -> List[Tuple[str, str, str]]:
...
[Section titled “(default) ImplicitPathExtractor”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#default-implicitpathextractor)
...
[Section titled “DynamicLLMPathExtractor”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#dynamicllmpathextractor)
...
[Section titled “SchemaLLMPathExtractor”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#schemallmpathextractor)
...
[Section titled “Retrieval and Querying”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#retrieval-and-querying)
...
[Section titled “(default) LLMSynonymRetriever”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#default-llmsynonymretriever)
...
defparse_fn(self, output: str) -> list[str]:
...
return[x.strip().capitalize() forin matches if x.strip()]
...
[Section titled “(default, if supported) VectorContextRetriever”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#default-if-supported-vectorcontextretriever)
...
[Section titled “TextToCypherRetriever”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#texttocypherretriever)
...
[Section titled “CypherTemplateRetriever”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#cyphertemplateretriever)
...
## Storage
[Section titled “Storage”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#storage)
...
### Saving to/from disk
[Section titled “Saving to/from disk”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#saving-tofrom-disk)
...
[Section titled “Saving and Loading with Integrations”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#saving-and-loading-with-integrations)
...
[Section titled “Using the Property Graph Store Directly”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#using-the-property-graph-store-directly)
...
source_chunk =TextNode="source",text="My llama has an index.")
...
[Section titled “Advanced Customization”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#advanced-customization)
...
[Section titled “Sub-Classing Extractors”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#sub-classing-extractors)
...
classMyGraphExtractor(TransformComponent):
...
[Section titled “Sub-Classing Retrievers”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#sub-classing-retrievers)
...
definit(self, my_option_1: bool=False, **kwargs) -> None:
...
# Examples
[Section titled “Examples”](https://developers.llamaindex.ai/python/framework/module_guides/indexing/lpg_index_guide/#examples)
Below, you can find some example notebooks showcasing the `PropertyGraphIndex`
  * [Advanced Usage with Neo4j and local models](https://developers.llamaindex.ai/python/examples/property_graph/property_graph_advanced)
  * [Using a Property Graph Store](https://developers.llamaindex.ai/python/examples/property_graph/graph_store)
  * [Creating a Custom Graph Retriever](https://developers.llamaindex.ai/python/examples/property_graph/property_graph_custom_retriever)
  * [Comparing KG Extractors](https://developers.llamaindex.ai/python/examples/property_graph/dynamic_kg_extraction)
