[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parse_region/#_top)
...
[Section titled “Parsing only some pages”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parse_region/#parsing-only-some-pages)
...
[Section titled “Parsing only a targeted area of a document”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parse_region/#parsing-only-a-targeted-area-of-a-document)
...
## Bounding box (legacy)
[Section titled “Bounding box (legacy)”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parse_region/#bounding-box-legacy)
...
[Section titled “Limiting number of page to parse”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/parse_region/#limiting-number-of-page-to-parse)
