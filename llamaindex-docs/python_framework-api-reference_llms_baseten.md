...
Source code in `llama_index/llms/baseten/base.py`
```
 25
 26
 27
...
---|---  
###  acomplete `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/llms/baseten/#llama_index.llms.baseten.Baseten.acomplete "Permanent link")
```
