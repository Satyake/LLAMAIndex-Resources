# Gaudi
##  GaudiLLM [#](https://developers.llamaindex.ai/python/framework-api-reference/llms/gaudi/#llama_index.llms.gaudi.GaudiLLM "Permanent link")
Bases: 
GaudiLLM LLM.
Examples:
...
Source code in `llama_index/llms/gaudi/base.py`
```
 27
 28
 29
