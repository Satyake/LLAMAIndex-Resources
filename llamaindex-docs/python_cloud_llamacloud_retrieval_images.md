...
Here is an example of setting this up using the [`LlamaCloudIndex` class](https://developers.llamaindex.ai/python/cloud/llamacloud/guides/framework_integration):
  * [ Python Framework ](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#tab-panel-86)
  * [ Python Client SDK ](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#tab-panel-87)
  * [ TypeScript Client SDK ](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#tab-panel-88)
...
Once your index is set up to support image indexing, and you’ve uploaded some files, you can retrieve images using the retriever interface on your `LlamaCloudIndex`. Image retrieval works similarly to text retrieval, but you must specify which types of images you want to retrieve: page screenshots and/or page figures.
...
[Section titled “Retrieving Page Screenshots”](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#retrieving-page-screenshots)
  * [ Python Framework ](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#tab-panel-84)
...
[Section titled “Retrieving Page Figures”](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#retrieving-page-figures)
  * [ Python Framework ](https://developers.llamaindex.ai/python/cloud/llamacloud/retrieval/images/#tab-panel-85)
