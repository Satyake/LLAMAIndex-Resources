[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/examples/parse_with_prompts/#_top)
...
## Setup
[Section titled “Setup”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/examples/parse_with_prompts/#setup)
...
[Section titled “Parse Receipt With No Instructions”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/examples/parse_with_prompts/#parse-receipt-with-no-instructions)
...
[Section titled “Parse Receipt With Instructions”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/examples/parse_with_prompts/#parse-receipt-with-instructions)
