[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#_top)
# Routers
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
## Concept
[Section titled “Concept”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#concept)
...
## Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#usage-pattern)
...
## Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#usage-pattern-1)
...
## Defining a selector
[Section titled “Defining a selector”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#defining-a-selector)
...
[Section titled “Using as a Query Engine”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#using-as-a-query-engine)
...
[Section titled “Using as a Retriever”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#using-as-a-retriever)
...
selector=PydanticSingleSelector.from_defaults=llm),
...
[Section titled “Using selector as a standalone module”](https://developers.llamaindex.ai/python/framework/module_guides/querying/router/#using-selector-as-a-standalone-module)
...
More examples:
  ...
  * [SQL Router Query Engine](https://developers.llamaindex.ai/python/examples/query_engine/sqlrouterqueryengine)
