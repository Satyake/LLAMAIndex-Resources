[Skip to content](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#_top)
...
## What is Nile?
[Section titled “What is Nile?”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#what-is-nile)
...
[Section titled “Getting Started with Nile”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#getting-started-with-nile)
...
[Section titled “Additional Resources”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#additional-resources)
...
## Before you begin
[Section titled “Before you begin”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#before-you-begin)
### Install dependencies
[Section titled “Install dependencies”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#install-dependencies)
...
[Section titled “Setup connection to Nile database”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#setup-connection-to-nile-database)
...
### Setup OpenAI
[Section titled “Setup OpenAI”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#setup-openai)
...
[Section titled “Multi-tenant similarity search”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#multi-tenant-similarity-search)
...
### Download data
[Section titled “Download data”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#download-data)
```
...
### Load documents
[Section titled “Load documents”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#load-documents)
...
[Section titled “Enrich documents with tenant metadata”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#enrich-documents-with-tenant-metadata)
...
[Section titled “Creating a VectorStore index with NileVectorStore”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#creating-a-vectorstore-index-with-nilevectorstore)
...
[Section titled “Querying the index for each tenant”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#querying-the-index-for-each-tenant)
...
[Section titled “Querying existing embeddings”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#querying-existing-embeddings)
...
[Section titled “Using ANN indexes for approximate nearest neighbor search”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#using-ann-indexes-for-approximate-nearest-neighbor-search)
...
### IVFFlat Index
[Section titled “IVFFlat Index”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#ivfflat-index)
...
### HNSW Index
[Section titled “HNSW Index”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#hnsw-index)
...
[Section titled “Additional VectorStore operations”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#additional-vectorstore-operations)
### Metadata Filters
[Section titled “Metadata Filters”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#metadata-filters)
...
### Deleting Documents
[Section titled “Deleting Documents”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/nilevectorstore/#deleting-documents)
