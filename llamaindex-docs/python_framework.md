[Skip to content](https://developers.llamaindex.ai/python/framework/#_top)
# Welcome to LlamaIndex 🦙 !
Copy as Markdown
MCP Server
Copy MCP URL  [ Install in Cursor ](cursor://anysphere.cursor-deeplink/mcp/install?name=llama-index-docs&config=eyJ1cmwiOiJodHRwczovL2RldmVsb3BlcnMubGxhbWFpbmRleC5haS9tY3AifQ==) Copy Claude config  Copy Codex config 
LlamaIndex is the leading framework for building LLM-powered agents over your data with [LLMs](https://en.wikipedia.org/wiki/Large_language_model) and [workflows](https://developers.llamaindex.ai/python/llamaagents/workflows).
...
## Introduction
[Section titled “Introduction”](https://developers.llamaindex.ai/python/framework/#introduction)
### What are agents?
[Section titled “What are agents?”](https://developers.llamaindex.ai/python/framework/#what-are-agents)
[Agents](https://developers.llamaindex.ai/python/framework/understanding/agent) are LLM-powered knowledge assistants that use tools to perform tasks like research, data extraction, and more. Agents range from simple question-answering to being able to sense, decide and take actions in order to complete tasks.
...
### What are workflows?
[Section titled “What are workflows?”](https://developers.llamaindex.ai/python/framework/#what-are-workflows)
[Workflows](https://developers.llamaindex.ai/python/llamaagents/workflows) are multi-step processes that combine one or more agents, data connectors, and other tools to complete a task. They are event-driven software that allows you to combine RAG data sources and multiple agents to create a complex application that can perform a wide variety of tasks with reflection, error-correction, and other hallmarks of advanced LLM applications. You can then [deploy these agentic workflows](https://developers.llamaindex.ai/python/workflows/deployment/) as production microservices.
### What is context augmentation?
[Section titled “What is context augmentation?”](https://developers.llamaindex.ai/python/framework/#what-is-context-augmentation)
...
The most popular example of context-augmentation is [Retrieval-Augmented Generation or RAG](https://developers.llamaindex.ai/python/framework/getting_started/concepts), which combines context with LLMs at inference time.
### LlamaIndex is the framework for Context-Augmented LLM Applications
[Section titled “LlamaIndex is the framework for Context-Augmented LLM Applications”](https://developers.llamaindex.ai/python/framework/#llamaindex-is-the-framework-for-context-augmented-llm-applications)
...
## Use cases
[Section titled “Use cases”](https://developers.llamaindex.ai/python/framework/#use-cases)
Some popular use cases for LlamaIndex and context augmentation in general include:
  * [Question-Answering](https://developers.llamaindex.ai/python/framework/use_cases/q_and_a) (Retrieval-Augmented Generation aka RAG)
  * [Document Understanding and Data Extraction](https://developers.llamaindex.ai/python/framework/use_cases/extraction)
  * [Autonomous Agents](https://developers.llamaindex.ai/python/framework/use_cases/agents) that can perform research and take actions
  * [Multi-modal applications](https://developers.llamaindex.ai/python/framework/use_cases/multimodal) that combine text, images, and other data types
  * [Fine-tuning](https://developers.llamaindex.ai/python/framework/use_cases/fine_tuning) models on data to improve performance


Check out our [use cases](https://developers.llamaindex.ai/python/framework/use_cases) documentation for more examples and links to tutorials.
### 👨‍👩‍👧‍👦 Who is LlamaIndex for?
[Section titled “👨‍👩‍👧‍👦 Who is LlamaIndex for?”](https://developers.llamaindex.ai/python/framework/#-who-is-llamaindex-for)
...
## Getting Started
[Section titled “Getting Started”](https://developers.llamaindex.ai/python/framework/#getting-started)
LlamaIndex is available in Python (these docs) and [Typescript](https://ts.llamaindex.ai/). If you’re not sure where to start, we recommend reading [how to read these docs](https://developers.llamaindex.ai/python/framework/getting_started/reading) which will point you to the right place based on your experience level.
### 30 second quickstart
[Section titled “30 second quickstart”](https://developers.llamaindex.ai/python/framework/#30-second-quickstart)
...
If any part of this trips you up, don’t worry! Check out our more comprehensive starter tutorials using [remote APIs like OpenAI](https://developers.llamaindex.ai/python/framework/getting_started/starter_example) or [any model that runs on your laptop](https://developers.llamaindex.ai/python/framework/getting_started/starter_example_local).
## LlamaCloud
[Section titled “LlamaCloud”](https://developers.llamaindex.ai/python/framework/#llamacloud)
...
## Community
[Section titled “Community”](https://developers.llamaindex.ai/python/framework/#community)
Need help? Have a feature suggestion? Join the LlamaIndex community:


### Getting the library
[Section titled “Getting the library”](https://developers.llamaindex.ai/python/framework/#getting-the-library)
  * LlamaIndex Python 
...
### Contributing
[Section titled “Contributing”](https://developers.llamaindex.ai/python/framework/#contributing)
...
[Section titled “LlamaIndex Ecosystem”](https://developers.llamaindex.ai/python/framework/#llamaindex-ecosystem)
