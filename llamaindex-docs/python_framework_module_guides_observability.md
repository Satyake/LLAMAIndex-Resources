[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/observability/#_top)
# Observability
Copy as Markdown
MCP Server
...
### SigNoz
[Section titled “SigNoz”](https://developers.llamaindex.ai/python/framework/module_guides/observability/#signoz)
...
pipinstallllama-indexlangfuseopeninference-instrumentation-llama-index
...
The simplest way to get started and try out Literal AI is to signup on our [cloud instance](https://cloud.getliteral.ai/). You can then navigate to **Settings** , grab your API key, and start logging!
#### Usage Pattern
...
exportOPIK_API_KEY="<OPIK_API_KEY>"




exportOPIK_WORKSPACE="<OPIK_WORKSPACE - Often the same as your API key>"
...
pipinstallagentallama-indexopeninference-instrumentation-llama-index
...
defdocument_search_app(user_query: str):
...
#### Example Guides
[Section titled “Example Guides”](https://developers.llamaindex.ai/python/framework/module_guides/observability/#example-guides-6)
...
pipinstall-Udeepevalllama-index
...
#### Usage Pattern
[Section titled “Usage Pattern”](https://developers.llamaindex.ai/python/framework/module_guides/observability/#usage-pattern-21)
```
