[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/metadata/#_top)
# Metadata
Copy as Markdown
MCP Server
...
## Result format
[Section titled “Result format”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/metadata/#result-format)
```
...
## Page objects
[Section titled “Page objects”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/metadata/#page-objects)
...
## Retrieving images
[Section titled “Retrieving images”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/metadata/#retrieving-images)
...
## Slide speaker notes
[Section titled “Slide speaker notes”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/metadata/#slide-speaker-notes)
