# Auto merging
##  BaseRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BaseRetriever "Permanent link")
...
---|---  
###  retrieve [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BaseRetriever.retrieve "Permanent link")
```
...
---|---  
##  BaseImageRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BaseImageRetriever "Permanent link")
Bases: `PromptMixin`, `DispatcherSpanMixin`
...
---|---  
###  text_to_image_retrieve [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BaseImageRetriever.text_to_image_retrieve "Permanent link")
```
...
---|---  
###  image_to_image_retrieve [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BaseImageRetriever.image_to_image_retrieve "Permanent link")
```
...
---|---  
##  EmptyIndexRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.EmptyIndexRetriever "Permanent link")
Bases: 
EmptyIndex query.
...
---|---  
##  KeywordTableSimpleRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.KeywordTableSimpleRetriever "Permanent link")
Bases: 
...
---|---  
##  KGTableRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.KGTableRetriever "Permanent link")
Bases: 
KG Table Retriever.
...
---|---  
##  KnowledgeGraphRAGRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.KnowledgeGraphRAGRetriever "Permanent link")
Bases: 
...
---|---  
##  SummaryIndexEmbeddingRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SummaryIndexEmbeddingRetriever "Permanent link")
Bases: 
...
---|---  
##  SummaryIndexLLMRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SummaryIndexLLMRetriever "Permanent link")
Bases: 
...
---|---  
##  SummaryIndexRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SummaryIndexRetriever "Permanent link")
Bases: 
...
---|---  
##  BasePGRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BasePGRetriever "Permanent link")
Bases: 
...
---|---  
###  add_source_text [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BasePGRetriever.add_source_text "Permanent link")
```
...
---|---  
###  async_add_source_text `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BasePGRetriever.async_add_source_text "Permanent link")
```
...
---|---  
###  retrieve_from_graph `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BasePGRetriever.retrieve_from_graph "Permanent link")
```
...
---|---  
###  aretrieve_from_graph `abstractmethod` `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.BasePGRetriever.aretrieve_from_graph "Permanent link")
```
...
---|---  
##  CustomPGRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.CustomPGRetriever "Permanent link")
Bases: 
...
---|---  
###  init `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.CustomPGRetriever.init "Permanent link")
```
init(**kwargs: ) -> None
...
---|---  
###  custom_retrieve `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.CustomPGRetriever.custom_retrieve "Permanent link")
```
...
---|---  
###  acustom_retrieve `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.CustomPGRetriever.acustom_retrieve "Permanent link")
```
...
---|---  
##  CypherTemplateRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.CypherTemplateRetriever "Permanent link")
Bases: 
...
---|---  
##  LLMSynonymRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.LLMSynonymRetriever "Permanent link")
Bases: 
...
---|---  
##  PGRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.PGRetriever "Permanent link")
Bases: 
...
---|---  
##  TextToCypherRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TextToCypherRetriever "Permanent link")
Bases: 
...
---|---  
##  VectorContextRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.VectorContextRetriever "Permanent link")
Bases: 
...
---|---  
##  NLSQLRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.NLSQLRetriever "Permanent link")
Bases: , `PromptMixin`
...
---|---  
###  retrieve_with_metadata [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.NLSQLRetriever.retrieve_with_metadata "Permanent link")
```
...
---|---  
###  aretrieve_with_metadata `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.NLSQLRetriever.aretrieve_with_metadata "Permanent link")
```
...
---|---  
##  SQLParserMode [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SQLParserMode "Permanent link")
Bases: `str`, `Enum`
SQL Parser Mode.
Source code in `llama_index/core/indices/struct_store/sql_retriever.py`
```
...
---|---  
##  SQLRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SQLRetriever "Permanent link")
Bases: 
SQL Retriever.
...
---|---  
###  retrieve_with_metadata [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.SQLRetriever.retrieve_with_metadata "Permanent link")
```
retrieve_with_metadata(str_or_query_bundle: QueryType) -> Tuple[[], ]
...
---|---  
##  TreeAllLeafRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TreeAllLeafRetriever "Permanent link")
Bases: 
...
---|---  
##  TreeSelectLeafEmbeddingRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TreeSelectLeafEmbeddingRetriever "Permanent link")
Bases: 
...
---|---  
##  TreeSelectLeafRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TreeSelectLeafRetriever "Permanent link")
Bases: 
...
---|---  
##  TreeRootRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TreeRootRetriever "Permanent link")
Bases: 
Tree root retriever.
...
---|---  
##  VectorIndexAutoRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.VectorIndexAutoRetriever "Permanent link")
...
---|---  
##  VectorIndexRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.VectorIndexRetriever "Permanent link")
Bases: 
...
---|---  
###  similarity_top_k `property` `writable` [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.VectorIndexRetriever.similarity_top_k "Permanent link")
```
similarity_top_k: 
...
Return similarity top k.
##  AutoMergingRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.AutoMergingRetriever "Permanent link")
Bases: 
...
---|---  
##  QueryFusionRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.QueryFusionRetriever "Permanent link")
Bases: 
...
---|---  
##  RecursiveRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.RecursiveRetriever "Permanent link")
Bases: 
Recursive retriever.
...
---|---  
###  retrieve_all [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.RecursiveRetriever.retrieve_all "Permanent link")
```
...
---|---  
##  RouterRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.RouterRetriever "Permanent link")
Bases: 
Router retriever.
...
---|---  
##  TransformRetriever [#](https://developers.llamaindex.ai/python/framework-api-reference/retrievers/auto_merging/#llama_index.core.retrievers.TransformRetriever "Permanent link")
Bases: 
Transform Retriever.
...
---|---  
options: members: - AutoMergingRetriever
