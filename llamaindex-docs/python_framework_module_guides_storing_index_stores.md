[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#_top)
# Index Stores
Copy as Markdown
MCP Server
...
See the [API Reference](https://developers.llamaindex.ai/python/framework-api-reference/storage/index_store) for more details.
### Simple Index Store
[Section titled “Simple Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#simple-index-store)
...
### MongoDB Index Store
[Section titled “MongoDB Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#mongodb-index-store)
...
index_store = MongoIndexStore.from_uri="<mongodb+srv://...>")
...
A more complete example can be found [here](https://developers.llamaindex.ai/python/examples/docstore/mongodocstoredemo)
### Redis Index Store
[Section titled “Redis Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#redis-index-store)
...
A more complete example can be found [here](https://developers.llamaindex.ai/python/examples/docstore/redisdocstoreindexstoredemo)
### Couchbase Index Store
[Section titled “Couchbase Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#couchbase-index-store)
...
[Section titled “Tablestore Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#tablestore-index-store)
...
A more complete example can be found [here](https://developers.llamaindex.ai/python/examples/docstore/tablestoredocstoredemo)
### Google AlloyDB Index Store
[Section titled “Google AlloyDB Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#google-alloydb-index-store)
Similarly to document stores, we can also use [`AlloyDB`](https://cloud.google.com/products/alloydb) as the storage backend of the index store. This tutorial demonstrates the synchronous interface. All synchronous methods have corresponding asynchronous methods.
Terminal window```
...
A more detailed guide can be found [here](https://developers.llamaindex.ai/python/examples/docstore/alloydbdocstoredemo)
### Google Cloud SQL for PostgreSQL Index Store
[Section titled “Google Cloud SQL for PostgreSQL Index Store”](https://developers.llamaindex.ai/python/framework/module_guides/storing/index_stores/#google-cloud-sql-for-postgresql-index-store)
Similarly to document stores, we can also use [`Cloud SQL for PostgreSQL`](https://cloud.google.com/sql) as the storage backend of the index store. This tutorial demonstrates the synchronous interface. All synchronous methods have corresponding asynchronous methods.
Terminal window```
...
A more detailed guide can be found [here](https://developers.llamaindex.ai/python/examples/docstore/cloudsqlpgdocstoredemo)
