[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#_top)
# Querying
Copy as Markdown
MCP Server
...
## Getting started
[Section titled “Getting started”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#getting-started)
...
## Stages of querying
[Section titled “Stages of querying”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#stages-of-querying)
...
[Section titled “Customizing the stages of querying”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#customizing-the-stages-of-querying)
...
[Section titled “Configuring retriever”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#configuring-retriever)
```
...
[Section titled “Configuring node postprocessors”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#configuring-node-postprocessors)
...
[Section titled “Configuring response synthesis”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#configuring-response-synthesis)
...
## Structured Outputs
[Section titled “Structured Outputs”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#structured-outputs)
You may want to ensure your output is structured. See our [Query Engines + Pydantic Outputs](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs/query_engine) to see how to extract a Pydantic object from a query engine class.
Also make sure to check out our entire [Structured Outputs](https://developers.llamaindex.ai/python/framework/module_guides/querying/structured_outputs) guide.
## Creating your own Query Workflow
[Section titled “Creating your own Query Workflow”](https://developers.llamaindex.ai/python/framework/understanding/rag/querying/#creating-your-own-query-workflow)
...
Take a look at our [Workflow Guide](https://developers.llamaindex.ai/python/framework/module_guides/workflow) for more details.
