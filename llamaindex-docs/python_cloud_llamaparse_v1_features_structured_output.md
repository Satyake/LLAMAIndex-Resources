[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#_top)
...
[Section titled “About Structured Output”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#about-structured-output)
...
You then need to provide either:
  ...
  * [ Python (Schema) ](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#tab-panel-458)
  * [ Python (Preset) ](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#tab-panel-460)
...
[Section titled “Supported Pre-defined Schemas”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#supported-pre-defined-schemas)
## imFeelingLucky
[Section titled “imFeelingLucky”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#imfeelinglucky)
...
## Invoice
[Section titled “Invoice”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#invoice)
Standard invoice schema for line items, tax, and totals
  * [ Invoice Schema ](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#tab-panel-463)
...
[Section titled “Structured Output: Invoice Schema”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#structured-output-invoice-schema)
Type: `object`
**_Properties_**
...
## Resume
[Section titled “Resume”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#resume)
...
[Section titled “Structured Output: Resume Schema”](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#structured-output-resume-schema)
    ...
    * Type: `array`
      ...
      * **_Properties_**
        ...
        * **url**
          ...
          * String format must be a “uri”
        * **startDate**
          * $ref: [#/definitions/iso8601](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#/definitions/iso8601)
        * **endDate**
          * $ref: [#/definitions/iso8601](https://developers.llamaindex.ai/python/cloud/llamaparse/v1/features/structured_output/#/definitions/iso8601)
        * **summary**
