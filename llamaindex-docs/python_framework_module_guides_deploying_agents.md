[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#_top)
# Agents
Copy as Markdown
MCP Server
...
The `FunctionAgent` is a type of agent that uses an LLM provider’s function/tool calling capabilities to execute tools. Other types of agents, such as [`ReActAgent`](https://developers.llamaindex.ai/python/examples/agent/react_agent) and [`CodeActAgent`](https://developers.llamaindex.ai/python/examples/agent/code_act_agent), use different prompting strategies to execute tools.
You can visit [the agents guide](https://developers.llamaindex.ai/python/framework/understanding/agent) to learn more about agents and their capabilities.
## Tools
[Section titled “Tools”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#tools)
...
You can read more about configuring tools in the [tools guide](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/tools)
## Memory
[Section titled “Memory”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#memory)
...
You can read more about configuring memory in the [memory guide](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/memory)
## Multi-Modal Agents
[Section titled “Multi-Modal Agents”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#multi-modal-agents)
...
## Multi-Agent Systems
[Section titled “Multi-Agent Systems”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#multi-agent-systems)
...
This is only one way to build multi-agent systems. Read on to learn more about [multi-agent systems](https://developers.llamaindex.ai/python/framework/understanding/agent/multi_agent).
## Manual Agents
[Section titled “Manual Agents”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#manual-agents)
...
defselect_song(song_name: str) -> str:
...
returnf"Song selected: {song_name}"
...
[Section titled “Examples / Module Guides”](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/#examples--module-guides)
You can find a more complete list of examples and module guides in the [module guides page](https://developers.llamaindex.ai/python/framework/module_guides/deploying/agents/modules).
