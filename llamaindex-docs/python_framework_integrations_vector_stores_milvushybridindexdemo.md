[Skip to content](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#_top)
...
## Prerequisites
[Section titled “Prerequisites”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#prerequisites)
...
[Section titled “Hybrid Search with BM25”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#hybrid-search-with-bm25)
...
[Section titled “Customize text analyzer”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#customize-text-analyzer)
...
[Section titled “Hybrid Search with Other Sparse Embedding”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#hybrid-search-with-other-sparse-embedding)
...
[Section titled “Customize Sparse Embedding Function”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#customize-sparse-embedding-function)
...
classExampleEmbeddingFunction(BaseSparseEmbeddingFunction):
...
defencode_queries(self, queries: List[str]):
...
defencode_documents(self, documents: List[str]):
...
def_to_standard_dict(self, raw_output):
...
[Section titled “Customize hybrid reranker”](https://developers.llamaindex.ai/python/framework/integrations/vector_stores/milvushybridindexdemo/#customize-hybrid-reranker)
