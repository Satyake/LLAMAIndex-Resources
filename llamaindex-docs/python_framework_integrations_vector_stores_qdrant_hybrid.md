...
sparse_result_tuples.sort=lambdax: x[0],reverse=True)
...
dense_result_tuples.sort=lambdax: x[0],reverse=True)
...
fused_similarities.sort=lambdax: x[0],reverse=True)
