[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#_top)
...
## Flask Backend
[Section titled “Flask Backend”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#flask-backend)
...
[Section titled “Basic Flask - Handling User Index Queries”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#basic-flask---handling-user-index-queries)
...
[Section titled “Advanced Flask - Handling User Document Uploads”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#advanced-flask---handling-user-document-uploads)
...
if request.form.get("filename_as_doc_id",None) isnotNone:
...
if filepath isnotNoneand os.path.exists(filepath):
...
definsert_into_index(doc_text, doc_id=None):
...
## React Frontend
[Section titled “React Frontend”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#react-frontend)
...
### fetchDocuments.tsx
[Section titled “fetchDocuments.tsx”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#fetchdocumentstsx)
...
const fetchDocuments = async ():PromiseDocument[]> => {
...
### queryIndex.tsx
[Section titled “queryIndex.tsx”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#queryindextsx)
...
const queryIndex = async (query:string):PromiseQueryResponse> => {




const queryURLnewURL("http://localhost:5601/query?text=1");
...
### insertDocument.tsx
[Section titled “insertDocument.tsx”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#insertdocumenttsx)
...
const responseTextresponse.text();
...
exportdefault insertDocument;


```

### All the Other Frontend Good-ness
[Section titled “All the Other Frontend Good-ness”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#all-the-other-frontend-good-ness)
...
## Conclusion
[Section titled “Conclusion”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_app_guide/#conclusion)
