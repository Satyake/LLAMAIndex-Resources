...
eval_dataset =await dataset_generator.agenerate_dataset_from_nodes=60)
...
evaluator_c =CorrectnessEvaluator=eval_llm)




evaluator_s =SemanticSimilarityEvaluator=eval_llm)




evaluator_r =RelevancyEvaluator=eval_llm)




evaluator_f =FaithfulnessEvaluator=eval_llm)





pairwise_evaluator =PairwiseComparisonEvaluator=eval_llm)
