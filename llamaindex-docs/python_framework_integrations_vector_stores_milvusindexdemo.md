...
vector_store =MilvusVectorStore="./milvus_demo.db",overwrite=False)
...
filters=[ExactMatchFilter="file_name",value="uber_2021.pdf")]
...
filters=[ExactMatchFilter="file_name",value="paul_graham_essay.txt")]
