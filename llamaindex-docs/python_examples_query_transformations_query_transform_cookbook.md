[Skip to content](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#_top)
...
## Routing
[Section titled “Routing”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#routing)
...
## Query Rewriting
[Section titled “Query Rewriting”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#query-rewriting)
...
[Section titled “Query Rewriting (Custom)”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#query-rewriting-custom)
...
defgenerate_queries(query: str, llm, num_queries: int=4):
...
[Section titled “Query Rewriting (using QueryTransform)”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#query-rewriting-using-querytransform)
...
## Sub-Questions
[Section titled “Sub-Questions”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#sub-questions)
...
question_gen = OpenAIQuestionGenerator.from_defaults=llm)
...
[Section titled “Query Transformation with ReAct Prompt”](https://developers.llamaindex.ai/python/examples/query_transformations/query_transform_cookbook/#query-transformation-with-react-prompt)
...
tool1 = FunctionTool.from_defaults=execute_sql)




tool2 = FunctionTool.from_defaults=add)
