...
Base tool spec class.
Source code in `llama_index/core/tools/tool_spec/base.py`
```
 18
 19
 20
...
```
get_metadata_from_fn_name(fn_name: , spec_functions: Optional[[SPEC_FUNCTION_TYPE]] = None) -> Optional[]
...
```
to_tool_list(spec_functions: Optional[[SPEC_FUNCTION_TYPE]] = None, func_to_metadata_mapping: Optional[[, ]] = None) -> []
...
---|---  
###  to_tool_list_async `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/tools/tool_spec/#llama_index.core.tools.tool_spec.base.BaseToolSpec.to_tool_list_async "Permanent link")
```
to_tool_list_async(spec_functions: Optional[[SPEC_FUNCTION_TYPE]] = None, func_to_metadata_mapping: Optional[[, ]] = None) -> []
