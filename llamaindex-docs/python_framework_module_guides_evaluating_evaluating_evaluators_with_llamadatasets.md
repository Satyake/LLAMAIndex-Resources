[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_evaluators_with_llamadatasets/#_top)
...
evaluator =CorrectnessEvaluator=gemini_pro_llm)
...
[Section titled “The related LabelledPairwiseEvaluatorDataset”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_evaluators_with_llamadatasets/#the-related-labelledpairwiseevaluatordataset)
...
[Section titled “More learning materials”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_evaluators_with_llamadatasets/#more-learning-materials)
To see these datasets in action, be sure to checkout the notebooks listed below that benchmark LLM evaluators on slightly adapted versions of the MT-Bench dataset.
  * [MTBench Single Grading](https://developers.llamaindex.ai/python/examples/evaluation/mt_bench_single_grading)
  * [MTBench Human Judge](https://developers.llamaindex.ai/python/examples/evaluation/mt_bench_human_judgement)
