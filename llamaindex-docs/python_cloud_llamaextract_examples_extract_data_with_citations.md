[Skip to content](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#_top)
...
[Section titled “Connect to Llama Cloud”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#connect-to-llama-cloud)
...
[Section titled “Extract Data with Llama Extract Agent”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#extract-data-with-llama-extract-agent)
### Provide Your Custom Schema
[Section titled “Provide Your Custom Schema”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#provide-your-custom-schema)
...
classFinancialReport(BaseModel):
...
const FilingTypez.enum(['10 K', '10-Q', '10-K/A', '10-Q/A']);





const FinancialReportSchemaz.object({
...
description: z.string().describe("Short description of the filing and what it contains"),




filing_type: FilingType.describe("Type of SEC filing"),




filing_date: z.string().describe("Date when filing was submitted to SEC"),
...
unit: z.string().describe("Unit of financial figures (thousands, millions, etc.)"),




revenue: z.number().describe("Total revenue for period"),
...
[Section titled “Set Up Citations and Reasoning”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#set-up-citations-and-reasoning)
...
data_schema: z.toJSONSchema(FinancialReportSchema),
...
[Section titled “Demo Time - Download a PDF and Extract Data with Citations”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#demo-time---download-a-pdf-and-extract-data-with-citations)
...
withopen('/content/nvda_10k.pdf','wb') as f:
...
const url"https://raw.githubusercontent.com/run-llama/llama_cloud_services/refs/heads/main/examples/extract/data/sec_filings/nvda_10k.pdf"
...
[Section titled “Inspect Citations and Reasoning”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#inspect-citations-and-reasoning)


```


print(result.extraction_metadata)
...
console.log(result.extraction_metadata);
...
print(filing_info.extraction_metadata)


```

You should see something similar to this structure:
```
...
## What’s Next?
[Section titled “What’s Next?”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#whats-next)
...
#### Learn More
[Section titled “Learn More”](https://developers.llamaindex.ai/python/cloud/llamaextract/examples/extract_data_with_citations/#learn-more)
