...
##  LoadAndSearchToolSpec [#](https://developers.llamaindex.ai/python/framework-api-reference/tools/load_and_search/#llama_index.core.tools.tool_spec.load_and_search.base.LoadAndSearchToolSpec "Permanent link")
Bases: 
...
---|---  
###  from_defaults `classmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/tools/load_and_search/#llama_index.core.tools.tool_spec.load_and_search.base.LoadAndSearchToolSpec.from_defaults "Permanent link")
```
from_defaults(tool: , index_cls: Optional[[]] = None, index_kwargs: Optional[] = None, name: Optional[] = None, description: Optional[] = None, fn_schema: Optional[[BaseModel]] = None) -> 
...
---|---  
options: members: - LoadAndSearchToolSpec
