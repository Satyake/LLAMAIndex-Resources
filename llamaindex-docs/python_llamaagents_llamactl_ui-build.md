...
const basePathprocess.env.LLAMA_DEPLOY_DEPLOYMENT_BASE_PATH;




const portprocess.env.PORTparseInt(process.env.PORT)undefined;
...
const deploymentNameprocess.env.LLAMA_DEPLOY_DEPLOYMENT_NAME;




const projectIdprocess.env.LLAMA_DEPLOY_PROJECT_ID;
...
src={`${base.replace(/\/$/, "")}/images/logo.png`} />
...
const baseprocess.env.NEXT_PUBLIC_LLAMA_DEPLOY_DEPLOYMENT_BASE_PATH || "";
...
returnsrc={`${base}/images/logo.png`}alt="logo" />;
