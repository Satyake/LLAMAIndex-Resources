...
you_api_key = os.environ.get("YDC_API_KEY") orgetpass(
...
print(f"Retrieved (retrieved_results)} results")
...
print(f"Retrieved (retrieved_results)} results asynchronously")
...
print(f"Retrieved (retrieved_results)} recent results from the US")
...
anthropic_api_key = os.environ.get("ANTHROPIC_API_KEY") orgetpass(
