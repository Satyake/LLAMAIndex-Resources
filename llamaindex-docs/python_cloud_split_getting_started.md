...
### API/SDK Usage
[Section titled “API/SDK Usage”](https://developers.llamaindex.ai/python/cloud/split/getting_started/#apisdk-usage)
Check out the [API guide](https://developers.llamaindex.ai/python/cloud/split/getting_started/api) for a complete walkthrough.
### Typical Flow
