[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#_top)
...
## What We’re Building
[Section titled “What We’re Building”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#what-were-building)
...
[Section titled “Architectural Overview”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#architectural-overview)
...
## System Requirements
[Section titled “System Requirements”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#system-requirements)
...
## Django Backend
[Section titled “Django Backend”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#django-backend)
### Project Directory Overview
[Section titled “Project Directory Overview”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#project-directory-overview)
The Delphic application has a structured backend directory organization that follows common Django project conventions. From the repo root, in the `./delphic` subfolder, the main folders are:
  ...
  * `tests.py`: Unit tests for the app
  ...
  1. `tasks`: This directory contains tasks for asynchronous processing using Celery. The `index_tasks.py` file includes the tasks for creating vector indexes.
  2. `users`: This directory is dedicated to user management, including:
  3. `utils`: This directory contains utility modules and functions that are used across the application, such as custom storage backends, path helpers, and collection-related utilities.


### Database Models
[Section titled “Database Models”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#database-models)
...
### Django Ninja API
[Section titled “Django Ninja API”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#django-ninja-api)
...
key =Noneifgetattr(request,"auth",None) isNoneelse request.auth
...
awaitsync_to_async(collection_instance.save)()
...
awaitsync_to_async(document.save)()
...
returnawaitsync_to_async(CollectionModelSchema)(...)


```

  1. `/collections/query` — a POST endpoint to query a document collection using the LLM. Accepts a JSON payload containing `collection_id` and `query_str`, and returns a response generated by querying the collection. We don’t actually use this endpoint in our chat GUI (We use a websocket - see below), but you could build an app to integrate to this REST endpoint to query a specific collection.
...
```
  ...
  1. `/collections/available`: A GET endpoint that returns a list of all collections created with the user’s API key. The output is serialized using the `CollectionModelSchema`.
...
asyncdefget_my_collections_view(request: HttpRequest):
...
return[{...} asyncfor collection in collections]


```

  1. `/collections/{collection_id}/add_file`: A POST endpoint to add a file to an existing collection. Accepts a `collection_id` path parameter, and form parameters such as `file` and `description`. Adds the file as a `Document` instance associated with the specified collection.
...
asyncdefadd_file_to_collection(
...
collection =awaitsync_to_async(Collection.objects.get=collection_id)


```

### Intro to Websockets
[Section titled “Intro to Websockets”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#intro-to-websockets)
...
### Websocket Handler
[Section titled “Websocket Handler”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#websocket-handler)
...
[Section titled “Websocket connect listener”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#websocket-connect-listener)
...
self.index =awaitload_collection_model(self.collection_id)
...
[Section titled “Websocket disconnect listener”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#websocket-disconnect-listener)
...
[Section titled “Websocket receive listener”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#websocket-receive-listener)
...
awaitself.send(json.dumps({"response": formatted_response},indent=4))
...
asyncdefload_collection_model(collection_id: str|int) -> VectorStoreIndex:
...
collection =await Collection.objects.aget=collection_id)
...
raiseValueError("No model exists for this collection!")
...
## React Frontend
[Section titled “React Frontend”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#react-frontend)
### Overview
[Section titled “Overview”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#overview)
...
[Section titled “Frontend Project Structure”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#frontend-project-structure)
...
[Section titled “Grabbing Collections from the Backend”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#grabbing-collections-from-the-backend)
...
const [collections, setCollections] = useStateCollectionModelSchema[]([]);
...
const accessTokenlocalStorage.getItem("accessToken");
...
[Section titled “Displaying Collections”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#displaying-collections)
...
collection.statusCollectionStatus.COMPLETE
...
selectedCollection.idcollection.id
...
### Chat View Component
[Section titled “Chat View Component”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#chat-view-component)
...
[Section titled “Chat Websocket Client”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#chat-websocket-client)
...
[Section titled “Rendering our Chat Messages”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#rendering-our-chat-messages)
...
## Deployment
[Section titled “Deployment”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#deployment)
### Prerequisites
[Section titled “Prerequisites”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#prerequisites)
...
### Build and Deploy
[Section titled “Build and Deploy”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#build-and-deploy)
...
[Section titled “Using the Application”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#using-the-application)
### Setup Users
[Section titled “Setup Users”](https://developers.llamaindex.ai/python/framework/understanding/putting_it_all_together/apps/fullstack_with_delphic/#setup-users)
