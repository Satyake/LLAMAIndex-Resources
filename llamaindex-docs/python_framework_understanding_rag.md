[Skip to content](https://developers.llamaindex.ai/python/framework/understanding/rag/#_top)
# Introduction to RAG
Copy as Markdown
MCP Server
...
### Stages within RAG
[Section titled “Stages within RAG”](https://developers.llamaindex.ai/python/framework/understanding/rag/#stages-within-rag)
...
[Section titled “Important concepts within RAG”](https://developers.llamaindex.ai/python/framework/understanding/rag/#important-concepts-within-rag)
There are also some terms you’ll encounter that refer to steps within each of these stages.
#### Loading stage
[Section titled “Loading stage”](https://developers.llamaindex.ai/python/framework/understanding/rag/#loading-stage)
[**Nodes and Documents**](https://developers.llamaindex.ai/python/framework/module_guides/loading/documents_and_nodes): A `Document` is a container around any data source - for instance, a PDF, an API output, or retrieve data from a database. A `Node` is the atomic unit of data in LlamaIndex and represents a “chunk” of a source `Document`. Nodes have metadata that relate them to the document they are in and to other nodes.
...
#### Indexing Stage
[Section titled “Indexing Stage”](https://developers.llamaindex.ai/python/framework/understanding/rag/#indexing-stage)
...
#### Querying Stage
[Section titled “Querying Stage”](https://developers.llamaindex.ai/python/framework/understanding/rag/#querying-stage)
