# Selection
Output parsers.
##  BaseOutputParser [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.BaseOutputParser "Permanent link")
...
---|---  
###  parse `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.BaseOutputParser.parse "Permanent link")
```
parse(output: ) -> 
...
---|---  
###  format [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.BaseOutputParser.format "Permanent link")
```
format(query: ) -> 
...
---|---  
###  format_messages [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.BaseOutputParser.format_messages "Permanent link")
```
...
---|---  
##  LangchainOutputParser [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.LangchainOutputParser "Permanent link")
Bases: 
...
---|---  
###  parse [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.LangchainOutputParser.parse "Permanent link")
```
parse(output: ) -> 
...
---|---  
###  format [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.LangchainOutputParser.format "Permanent link")
```
format(query: ) -> 
...
---|---  
##  PydanticOutputParser [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.PydanticOutputParser "Permanent link")
Bases: , `Generic[Model]`
...
---|---  
###  format_string `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.PydanticOutputParser.format_string "Permanent link")
```
format_string: 
...
Format string.
###  get_format_string [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.PydanticOutputParser.get_format_string "Permanent link")
```
...
---|---  
###  parse [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.PydanticOutputParser.parse "Permanent link")
```
parse(text: ) -> 
...
---|---  
###  format [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.PydanticOutputParser.format "Permanent link")
```
format(query: ) -> 
...
---|---  
##  SelectionOutputParser [#](https://developers.llamaindex.ai/python/framework-api-reference/output_parsers/selection/#llama_index.core.output_parsers.SelectionOutputParser "Permanent link")
Bases: 
