# Bedrock converse
##  BedrockConverse [#](https://developers.llamaindex.ai/python/framework-api-reference/llms/bedrock_converse/#llama_index.llms.bedrock_converse.BedrockConverse "Permanent link")
...
Source code in `llama_index/llms/bedrock_converse/base.py`
```
  62
  63
  64
...
---|---  
###  get_tool_calls_from_response [#](https://developers.llamaindex.ai/python/framework-api-reference/llms/bedrock_converse/#llama_index.llms.bedrock_converse.BedrockConverse.get_tool_calls_from_response "Permanent link")
```
...
---|---  
options: members: - BedrockConverse
