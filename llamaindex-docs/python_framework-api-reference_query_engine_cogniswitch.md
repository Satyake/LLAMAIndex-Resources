# Cogniswitch
##  BaseQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.BaseQueryEngine "Permanent link")
...
---|---  
##  NLSQLTableQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.NLSQLTableQueryEngine "Permanent link")
...
---|---  
###  sql_retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.NLSQLTableQueryEngine.sql_retriever "Permanent link")
```
sql_retriever: 
...
Get SQL retriever.
##  PGVectorSQLQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.PGVectorSQLQueryEngine "Permanent link")
Bases: `BaseSQLTableQueryEngine`
...
---|---  
###  sql_retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.PGVectorSQLQueryEngine.sql_retriever "Permanent link")
```
sql_retriever: 
...
Get SQL retriever.
##  SQLTableRetrieverQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SQLTableRetrieverQueryEngine "Permanent link")
Bases: `BaseSQLTableQueryEngine`
...
---|---  
###  sql_retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SQLTableRetrieverQueryEngine.sql_retriever "Permanent link")
```
sql_retriever: 
...
Get SQL retriever.
##  CitationQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CitationQueryEngine "Permanent link")
Bases: 
...
---|---  
###  retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CitationQueryEngine.retriever "Permanent link")
```
retriever: 
...
Get the retriever object.
###  from_args `classmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CitationQueryEngine.from_args "Permanent link")
```
...
---|---  
##  CogniswitchQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine "Permanent link")
Bases: 
...
---|---  
###  query_knowledge [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CogniswitchQueryEngine.query_knowledge "Permanent link")
```
...
---|---  
##  CustomQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CustomQueryEngine "Permanent link")
Bases: `BaseModel`, 
Custom query engine.
...
---|---  
###  custom_query `abstractmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CustomQueryEngine.custom_query "Permanent link")
```
...
---|---  
###  acustom_query `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.CustomQueryEngine.acustom_query "Permanent link")
```
...
---|---  
##  FLAREInstructQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.FLAREInstructQueryEngine "Permanent link")
Bases: 
...
---|---  
##  ComposableGraphQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.ComposableGraphQueryEngine "Permanent link")
Bases: 
...
---|---  
##  JSONalyzeQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.JSONalyzeQueryEngine "Permanent link")
...
---|---  
##  KnowledgeGraphQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.KnowledgeGraphQueryEngine "Permanent link")
Bases: 
...
---|---  
###  generate_query [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.KnowledgeGraphQueryEngine.generate_query "Permanent link")
```
...
---|---  
###  agenerate_query `async` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.KnowledgeGraphQueryEngine.agenerate_query "Permanent link")
```
...
---|---  
##  SimpleMultiModalQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SimpleMultiModalQueryEngine "Permanent link")
Bases: 
...
---|---  
###  retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SimpleMultiModalQueryEngine.retriever "Permanent link")
```
retriever: MultiModalVectorIndexRetriever
...
Get the retriever object.
###  image_query [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SimpleMultiModalQueryEngine.image_query "Permanent link")
```
...
---|---  
##  MultiStepQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.MultiStepQueryEngine "Permanent link")
Bases: 
...
---|---  
##  PandasQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.PandasQueryEngine "Permanent link")
Pandas query engine.
...
---|---  
##  RetrieverQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetrieverQueryEngine "Permanent link")
Bases: 
...
---|---  
###  retriever `property` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetrieverQueryEngine.retriever "Permanent link")
```
retriever: 
...
Get the retriever object.
###  from_args `classmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetrieverQueryEngine.from_args "Permanent link")
```
...
---|---  
##  RetryGuidelineQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetryGuidelineQueryEngine "Permanent link")
Bases: 
...
---|---  
##  RetryQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetryQueryEngine "Permanent link")
Bases: 
...
---|---  
##  RetrySourceQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetrySourceQueryEngine "Permanent link")
Bases: 
...
---|---  
##  RetrieverRouterQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RetrieverRouterQueryEngine "Permanent link")
Bases: 
...
---|---  
##  RouterQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.RouterQueryEngine "Permanent link")
Bases: 
Router query engine.
...
---|---  
##  ToolRetrieverRouterQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.ToolRetrieverRouterQueryEngine "Permanent link")
Bases: 
...
---|---  
##  SQLJoinQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SQLJoinQueryEngine "Permanent link")
Bases: 
...
---|---  
##  SQLAutoVectorQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SQLAutoVectorQueryEngine "Permanent link")
Bases: 
...
---|---  
###  from_sql_and_vector_query_engines `classmethod` [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SQLAutoVectorQueryEngine.from_sql_and_vector_query_engines "Permanent link")
```
...
---|---  
##  SubQuestionAnswerPair [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SubQuestionAnswerPair "Permanent link")
Bases: `BaseModel`
...
---|---  
##  SubQuestionQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.SubQuestionQueryEngine "Permanent link")
Bases: 
...
---|---  
##  TransformQueryEngine [#](https://developers.llamaindex.ai/python/framework-api-reference/query_engine/cogniswitch/#llama_index.core.query_engine.TransformQueryEngine "Permanent link")
Bases: 
...
---|---  
options: members: - CogniswitchQueryEngine
