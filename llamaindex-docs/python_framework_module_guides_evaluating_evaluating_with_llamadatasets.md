[Skip to content](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#_top)
...
[Section titled “Building A LabelledRagDataset”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#building-a-labelledragdataset)
...
[Section titled “Using A LabelledRagDataset”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#using-a-labelledragdataset)
...
[Section titled “Where To Find LabelledRagDataset’s”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#where-to-find-labelledragdatasets)
...
[Section titled “Contributing A LabelledRagDataset”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#contributing-a-labelledragdataset)
You can also contribute a `LabelledRagDataset` to [llamahub](https://llamahub.ai). Contributing a `LabelledRagDataset` involves two high level steps. Generally speaking, you must create the `LabelledRagDataset`, save it as a json and submit both this json file and the source text files to our [llama_datasets](https://github.com/run-llama/llama_datasets) Github repository. Additionally, you’ll have to make a pull request, to upload required metadata of the dataset to our [llama_hub](https://github.com/run-llama/llama-hub) Github repository.
Please refer to the “LlamaDataset Submission Template Notebook” linked below.
## Now, Go And Build Robust LLM Applications
[Section titled “Now, Go And Build Robust LLM Applications”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#now-go-and-build-robust-llm-applications)
...
## Resources
[Section titled “Resources”](https://developers.llamaindex.ai/python/framework/module_guides/evaluating/evaluating_with_llamadatasets/#resources)
  * [Labelled RAG datasets](https://developers.llamaindex.ai/python/examples/llama_dataset/labelled-rag-datasets)
  * [Downloading Llama datasets](https://developers.llamaindex.ai/python/examples/llama_dataset/downloading_llama_datasets)
