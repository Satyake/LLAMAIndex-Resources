[Skip to content](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#_top)
...
### Prerequisites
[Section titled “Prerequisites”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#prerequisites)
...
[Section titled “Connect to Oracle Database”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#connect-to-oracle-database)
...
### Load ONNX Model
[Section titled “Load ONNX Model”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#load-onnx-model)
...
### Create Credential
[Section titled “Create Credential”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#create-credential)
...
### Generate Embeddings
[Section titled “Generate Embeddings”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#generate-embeddings)
...
### End to End Demo
[Section titled “End to End Demo”](https://developers.llamaindex.ai/python/framework/integrations/embeddings/oracleai/#end-to-end-demo)
